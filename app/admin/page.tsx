...
export default function AdminDashboardPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // Revenue from orders (more accurate than products.soldCount)
      ...
      // Since we don't have visitors tracking yet, show 0%
      // TODO: Implement analytics tracking in future
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="p-6 space-y-6">
          {/* Stats Grid - REAL DATA FROM ORDERS */}
          ...
          {/* Recent Orders & Low Stock - TWO COLUMN GRID */}
